...
private:
 ...
 IExecutionContext& context_;SimulatedBackendConfig config_;std::atomic<bool> stopped_{false};bool configured_{false};bool cleanup_armed_{false};bool cleanup_recorded_{false};PlanId plan_id_{};TransmissionMode plan_mode_{TransmissionMode::WSPR};std::vector<Item> items_;std::string json_;
}; }
